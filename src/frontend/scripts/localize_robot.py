...
class MultiLocationMarkerNode(Node):
    def __init__(self):
        ...
        # For Robot 5.2, -0.5
        self.goal_x = 5.2  # Goal x-coordinate in meters
        self.goal_y = -0.5  # Goal y-coordinate in meters

        self.path = None  # Path to follow
        self.desination_go = None #Final path
        self.control_thread = None  # Thread for control loop
        self.lidar_thread = None   # Thread for lidar loop
    ...
    def compute_again(self,new_hypotheses):
        ...
        if self.compute_start:
            ...
            # max_range = 2 #For robot simulation
            max_range = 2
