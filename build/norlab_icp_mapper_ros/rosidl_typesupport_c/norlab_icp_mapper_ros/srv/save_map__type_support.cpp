...
static const _SaveMap_Request_type_support_symbol_names_t _SaveMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, norlab_icp_mapper_ros, srv, SaveMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, norlab_icp_mapper_ros, srv, SaveMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, norlab_icp_mapper_ros, srv, SaveMap_Request)() {
  return &::norlab_icp_mapper_ros::srv::rosidl_typesupport_c::SaveMap_Request_message_type_support_handle;
}
...
static const _SaveMap_Response_type_support_symbol_names_t _SaveMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, norlab_icp_mapper_ros, srv, SaveMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, norlab_icp_mapper_ros, srv, SaveMap_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, norlab_icp_mapper_ros, srv, SaveMap_Response)() {
  return &::norlab_icp_mapper_ros::srv::rosidl_typesupport_c::SaveMap_Response_message_type_support_handle;
}
...
static const _SaveMap_type_support_symbol_names_t _SaveMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, norlab_icp_mapper_ros, srv, SaveMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, norlab_icp_mapper_ros, srv, SaveMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, norlab_icp_mapper_ros, srv, SaveMap)() {
  return &::norlab_icp_mapper_ros::srv::rosidl_typesupport_c::SaveMap_service_type_support_handle;
}
