...
#include "norlab_icp_mapper_ros/srv/detail/load_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const norlab_icp_mapper_ros::srv::LoadMap_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  norlab_icp_mapper_ros::srv::LoadMap_Request & ros_message)
{
  // Member: map_file_name
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = norlab_icp_mapper_ros::srv::LoadMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const norlab_icp_mapper_ros::srv::LoadMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<norlab_icp_mapper_ros::srv::LoadMap_Request *>(
    untyped_ros_message);
...
{
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_LoadMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, norlab_icp_mapper_ros, srv, LoadMap_Request)() {
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_LoadMap_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_norlab_icp_mapper_ros
cdr_serialize(
  const norlab_icp_mapper_ros::srv::LoadMap_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  norlab_icp_mapper_ros::srv::LoadMap_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = norlab_icp_mapper_ros::srv::LoadMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const norlab_icp_mapper_ros::srv::LoadMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<norlab_icp_mapper_ros::srv::LoadMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_LoadMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, norlab_icp_mapper_ros, srv, LoadMap_Response)() {
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_LoadMap_Response__handle;
}
...
{
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_LoadMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, norlab_icp_mapper_ros, srv, LoadMap)() {
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_LoadMap__handle;
}
