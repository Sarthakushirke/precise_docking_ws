...
#include "norlab_icp_mapper_ros/srv/detail/save_map__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = norlab_icp_mapper_ros::srv::SaveMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const norlab_icp_mapper_ros::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<norlab_icp_mapper_ros::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = norlab_icp_mapper_ros::srv::SaveMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const norlab_icp_mapper_ros::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<norlab_icp_mapper_ros::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
{
  return &norlab_icp_mapper_ros::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
