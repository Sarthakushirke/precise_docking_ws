...
static const _LoadMap_Request_type_support_symbol_names_t _LoadMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, norlab_icp_mapper_ros, srv, LoadMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, norlab_icp_mapper_ros, srv, LoadMap_Request)),
  }
};
...
{
  return &::norlab_icp_mapper_ros::srv::rosidl_typesupport_cpp::LoadMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, norlab_icp_mapper_ros, srv, LoadMap_Request)() {
  return get_message_type_support_handle<norlab_icp_mapper_ros::srv::LoadMap_Request>();
}
...
static const _LoadMap_Response_type_support_symbol_names_t _LoadMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, norlab_icp_mapper_ros, srv, LoadMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, norlab_icp_mapper_ros, srv, LoadMap_Response)),
  }
};
...
{
  return &::norlab_icp_mapper_ros::srv::rosidl_typesupport_cpp::LoadMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, norlab_icp_mapper_ros, srv, LoadMap_Response)() {
  return get_message_type_support_handle<norlab_icp_mapper_ros::srv::LoadMap_Response>();
}
...
static const _LoadMap_type_support_symbol_names_t _LoadMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, norlab_icp_mapper_ros, srv, LoadMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, norlab_icp_mapper_ros, srv, LoadMap)),
  }
};
...
{
  return &::norlab_icp_mapper_ros::srv::rosidl_typesupport_cpp::LoadMap_service_type_support_handle;
}
