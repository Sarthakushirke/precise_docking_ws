...
#ifndef NORLAB_ICP_MAPPER_ROS__SRV__DETAIL__SAVE_TRAJECTORY__FUNCTIONS_H_
#define NORLAB_ICP_MAPPER_ROS__SRV__DETAIL__SAVE_TRAJECTORY__FUNCTIONS_H_
 ...
 * calls
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Request__init().
...
/**
 * It calls
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Request__fini()
 ...
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_norlab_icp_mapper_ros
...
/**
 * It calls
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_norlab_icp_mapper_ros
...
/**
 * It allocates the memory for the array and calls
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_norlab_icp_mapper_ros
...
/**
 * It calls
 * norlab_icp_mapper_ros__srv__SaveTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NORLAB_ICP_MAPPER_ROS__SRV__DETAIL__SAVE_TRAJECTORY__FUNCTIONS_H_
