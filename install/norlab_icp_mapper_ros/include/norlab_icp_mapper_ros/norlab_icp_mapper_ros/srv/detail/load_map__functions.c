...
norlab_icp_mapper_ros__srv__LoadMap_Request__init(norlab_icp_mapper_ros__srv__LoadMap_Request * msg)
{
  ...
  if (!std_msgs__msg__String__init(&msg->map_file_name)) {
    norlab_icp_mapper_ros__srv__LoadMap_Request__fini(msg);
    return false;
  }
  // pose
...
norlab_icp_mapper_ros__srv__LoadMap_Request__create()
{
  ...
  norlab_icp_mapper_ros__srv__LoadMap_Request * msg = (norlab_icp_mapper_ros__srv__LoadMap_Request *)allocator.allocate(sizeof(norlab_icp_mapper_ros__srv__LoadMap_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(norlab_icp_mapper_ros__srv__LoadMap_Request));
  bool success = norlab_icp_mapper_ros__srv__LoadMap_Request__init(msg);
  if (!success) {
...
norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence__init(norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  norlab_icp_mapper_ros__srv__LoadMap_Request * data = NULL;

  if (size) {
    data = (norlab_icp_mapper_ros__srv__LoadMap_Request *)allocator.zero_allocate(size, sizeof(norlab_icp_mapper_ros__srv__LoadMap_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = norlab_icp_mapper_ros__srv__LoadMap_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        norlab_icp_mapper_ros__srv__LoadMap_Request__fini(&data[i - 1]);
      }
...
norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence__fini(norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      norlab_icp_mapper_ros__srv__LoadMap_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence * array = (norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence *)allocator.allocate(sizeof(norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence__init(array, size);
  if (!success) {
...
norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence__destroy(norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence__are_equal(const norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence * lhs, const norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!norlab_icp_mapper_ros__srv__LoadMap_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  norlab_icp_mapper_ros__srv__LoadMap_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(norlab_icp_mapper_ros__srv__LoadMap_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    norlab_icp_mapper_ros__srv__LoadMap_Request * data =
      (norlab_icp_mapper_ros__srv__LoadMap_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!norlab_icp_mapper_ros__srv__LoadMap_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          norlab_icp_mapper_ros__srv__LoadMap_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!norlab_icp_mapper_ros__srv__LoadMap_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  norlab_icp_mapper_ros__srv__LoadMap_Response * msg = (norlab_icp_mapper_ros__srv__LoadMap_Response *)allocator.allocate(sizeof(norlab_icp_mapper_ros__srv__LoadMap_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(norlab_icp_mapper_ros__srv__LoadMap_Response));
  bool success = norlab_icp_mapper_ros__srv__LoadMap_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
norlab_icp_mapper_ros__srv__LoadMap_Response__destroy(norlab_icp_mapper_ros__srv__LoadMap_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    norlab_icp_mapper_ros__srv__LoadMap_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence__init(norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  norlab_icp_mapper_ros__srv__LoadMap_Response * data = NULL;

  if (size) {
    data = (norlab_icp_mapper_ros__srv__LoadMap_Response *)allocator.zero_allocate(size, sizeof(norlab_icp_mapper_ros__srv__LoadMap_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = norlab_icp_mapper_ros__srv__LoadMap_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        norlab_icp_mapper_ros__srv__LoadMap_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence__fini(norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      norlab_icp_mapper_ros__srv__LoadMap_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence * array = (norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence *)allocator.allocate(sizeof(norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence__destroy(norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence__are_equal(const norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence * lhs, const norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!norlab_icp_mapper_ros__srv__LoadMap_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  norlab_icp_mapper_ros__srv__LoadMap_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(norlab_icp_mapper_ros__srv__LoadMap_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    norlab_icp_mapper_ros__srv__LoadMap_Response * data =
      (norlab_icp_mapper_ros__srv__LoadMap_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!norlab_icp_mapper_ros__srv__LoadMap_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          norlab_icp_mapper_ros__srv__LoadMap_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!norlab_icp_mapper_ros__srv__LoadMap_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
