...
from localization_amcl.pf_localisation.util import rotateQuaternion, getHeading
from localization_amcl.pf_localisation.sensor_model import SensorModel
...
class GlobalLocalizationNode(Node):
    ...
    def scan_callback(self, msg):
        ...
        self.update_particle_cloud(msg)
    ...
    def update_particle_cloud(self, scan):
            ...
            for _ in range(M):
                ...
                rPoint.x = rx
                rPoint.y = ry
                rPoint.z = 0.0  # z is usually 0
                rotateQ = rotateQuaternion(q, rt - t)
                newPose = Pose()
                newPose.position = rPoint  # Set the position using rPoint
                newPose.orientation = rotateQ  # Set the orientation using rotateQ
            ...
            # Publish the updated particle cloud
            self._cloud_publisher.publish(self.particlecloud)
            # self.get_logger().info("Updated particle cloud published.")
